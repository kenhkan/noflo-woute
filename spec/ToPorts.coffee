...
describe 'ToPorts component', ->
  ...
  beforeEach ->
    ...
    globals.response = noflo.internalSocket.createSocket()
    ...
    globals.c.outPorts.response.attach globals.response
  ...
  describe 'when instantiated', ->
    ...
    it 'should have an output port', ->
      ...
      chai.expect(globals.c.outPorts.response).to.be.an 'object'
  ...
  describe 'sends packets to separate ports', ->
    ...
    it 'sends incoming request/response object into five different ports', (done) ->
      ...
      globals.response.on 'data', (data) ->
        chai.expect(data).to.deep.equal request.res

      globals.response.on 'disconnect', ->
        done()
    ...
    it 'retains groupings generated by noflo-webserver', (done) ->
      ...
      globals.response.on 'begingroup', (group) ->
